...
from scanner.Registration import AccRegistration
...
class PointCloudVisualizer(PipelineStageBase):
    ...
    def execute(self, in_obj):
        o3d.visualization.draw_geometries([in_obj])
...
class AccPtCVisualizerRT(PipelineStageBase):
    def __init__(self) -> None:
        super().__init__("visualizer (merged) (open3d)")
    ...
    def execute(self, in_obj):
        self.__vis.update_cloud(in_obj.get_merged())
        self.__vis.tick()
        # o3d.io.write_point_cloud("pcloud.ply", pcd)
